...
import { N as NodeApp, d as deserializeManifest } from './chunks/astro.32479da3.mjs';
...
const _page0  = () => import('./chunks/index@_@astro.39e8d0b5.mjs');
const _page1  = () => import('./chunks/login.form.cbd5fa09.mjs');
const _page2  = () => import('./chunks/login.3a1b83e2.mjs');
const _page3  = () => import('./chunks/listen@_@astro.b79e7dd7.mjs');
const _page4  = () => import('./chunks/login@_@astro.046d1dcd.mjs');
const _page5  = () => import('./chunks/_id_@_@ts.75b4cf4f.mjs');
const _page6  = () => import('./chunks/products@_@ts.a0b76111.mjs');
const _page7  = () => import('./chunks/cart@_@ts.776565a2.mjs');const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/login.form.async.ts", _page1],["src/pages/login.form.ts", _page2],["src/pages/listen.astro", _page3],["src/pages/login.astro", _page4],["src/pages/api/products/[id].ts", _page5],["src/pages/api/products.ts", _page6],["src/pages/api/cart.ts", _page7]]);
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/node","routes":[{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"/_astro/index.1ac8ad79.css"},{"type":"external","src":"/_astro/index.8300ad81.css"}],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/login.form.async","type":"endpoint","pattern":"^\\/login\\.form\\.async$","segments":[[{"content":"login.form.async","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.form.async.ts","pathname":"/login.form.async","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/login.form","type":"endpoint","pattern":"^\\/login\\.form$","segments":[[{"content":"login.form","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.form.ts","pathname":"/login.form","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"/_astro/index.1ac8ad79.css"},{"type":"external","src":"/_astro/listen.1315b0ef.css"}],"routeData":{"route":"/listen","type":"page","pattern":"^\\/listen\\/?$","segments":[[{"content":"listen","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/listen.astro","pathname":"/listen","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"/_astro/login.87cfea38.css"}],"routeData":{"route":"/login","type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/products/[id]","type":"endpoint","pattern":"^\\/api\\/products\\/([^/]+?)$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"products","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/api/products/[id].ts","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/products","type":"endpoint","pattern":"^\\/api\\/products$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"products","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/products.ts","pathname":"/api/products","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/cart","type":"endpoint","pattern":"^\\/api\\/cart$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"cart","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/cart.ts","pathname":"/api/cart","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","compressHTML":false,"markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true},"componentMetadata":[["/Users/jonathanmumm/src/escuchame.app/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/jonathanmumm/src/escuchame.app/src/pages/listen.astro",{"propagation":"none","containsHead":true}],["/Users/jonathanmumm/src/escuchame.app/src/pages/login.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(i,c,n)=>{let s=async()=>{await(await i())()},t=new IntersectionObserver(e=>{for(let o of e)if(o.isIntersecting){t.disconnect(),s();break}});for(let e of n.children)t.observe(e)};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","/src/pages/api/cart.ts":"chunks/pages/cart.ts.9632e79c.mjs","/src/pages/listen.astro":"chunks/pages/listen.astro.018db81f.mjs","/src/pages/login.astro":"chunks/pages/login.astro.19bacf53.mjs","/src/pages/login.form.async.ts":"chunks/pages/login.form.async.ts.2ff9c189.mjs","/src/pages/login.form.ts":"chunks/pages/login.form.ts.5eafc92b.mjs","/src/pages/api/products.ts":"chunks/pages/products.ts.9b52282c.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index@_@astro.39e8d0b5.mjs","\u0000@astro-page:src/pages/login.form.async@_@ts":"chunks/login.form.cbd5fa09.mjs","\u0000@astro-page:src/pages/login.form@_@ts":"chunks/login.3a1b83e2.mjs","\u0000@astro-page:src/pages/listen@_@astro":"chunks/listen@_@astro.b79e7dd7.mjs","\u0000@astro-page:src/pages/login@_@astro":"chunks/login@_@astro.046d1dcd.mjs","\u0000@astro-page:src/pages/api/products/[id]@_@ts":"chunks/_id_@_@ts.75b4cf4f.mjs","\u0000@astro-page:src/pages/api/products@_@ts":"chunks/products@_@ts.a0b76111.mjs","\u0000@astro-page:src/pages/api/cart@_@ts":"chunks/cart@_@ts.776565a2.mjs","@astrojs/react/client.js":"_astro/client.c67de31f.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/index.1ac8ad79.css","/_astro/index.8300ad81.css","/_astro/listen.1315b0ef.css","/_astro/login.87cfea38.css","/favicon.svg","/_astro/client.c67de31f.js","/images/products/cereal.jpg","/images/products/muffins.jpg","/images/products/oats.jpg","/images/products/yogurt.jpg"]}), {
	pageMap,
	renderers,
});
const _args = {"mode":"standalone","client":"file:///Users/jonathanmumm/src/escuchame.app/dist/client/","server":"file:///Users/jonathanmumm/src/escuchame.app/dist/server/","host":"0.0.0.0","port":3000};
